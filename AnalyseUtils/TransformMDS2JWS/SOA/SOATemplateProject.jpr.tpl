...
<jpr:project xmlns:jpr="http://xmlns.oracle.com/ide/project">
   ...
   <value n="defaultPackage" v="${project.name}"/>
   ...
   <hash n="oracle.jdeveloper.deploy.dt.DeploymentProfiles">
      <hash n="profileDefinitions">
         <hash n="${project.name}">
            ...
            <hash n="fileGroups">
               <list n="groups">
                  <hash>
                     <list n="contributors">
                        <hash>
                           <url n="location" path="SOA/"/>
                           <value n="type" v="1"/>
                        </hash>
                        <hash>
                           <url n="location" path="../src/"/>
                           <value n="type" v="1"/>
                        </hash>
                     </list>
                     ...
                     <hash n="filters">
                        <list n="rules">
                           <hash>
                              <value n="pattern" v="**/XSLNonDeployedFiles"/>
                              <value n="type" v="1"/>
                           </hash>
                           <hash>
                           ...
                           <hash>
                              <value n="pattern" v="META-INF/*.xml"/>
                              <value n="type" v="1"/>
                           </hash>
                           <hash>
                              <value n="pattern" v="SCA-INF/patch.xml"/>
                              <value n="type" v="1"/>
                           </hash>
                           <hash>
                              <value n="pattern" v="**"/>
            ...
            <url n="jarURL" path="deploy/sca_${project.name}.jar"/>
            <value n="profileClass" v="oracle.tip.tools.ide.fabric.deploy.sar.SarProfile"/>
            <value n="profileName" v="${project.name}"/>
         </hash>
      </hash>
      <list n="profileList">
         <string v="${project.name}"/>
      </list>
   </hash>
   <hash n="oracle.jdeveloper.model.J2eeSettings">
      <value n="j2eeWebAppName" v="${application}-${project.name}-webapp"/>
      <value n="j2eeWebContextRoot" v="${application}-${project.name}-context-root"/>
   </hash>
      ...
      <hash n="runConfigurationDefinitions">
         <hash n="Default">
            ...
            <hash n="oracle.jdevimpl.runner.debug.DebugConfiguration">
               <value n="remoteParameter:SOA:hostname" v="rhfuse.conclusion.local"/>
               <value n="remoteParameter:SOA:port" v="5004"/>
               <value n="remoteProtocol" v="SOA"/>
            </hash>
            <value n="remoteDebuggingProfiling" v="true"/>
            <url n="targetURL" path="SOA/composite.xml"/>
         </hash>
      </hash>
   </hash>
   <hash n="oracle.jdevimpl.config.JProjectLibraries">
      <list n="exportedReferences">
         ...
         <hash>
            <value n="id" v="BC4J Service Runtime"/>
            <value n="isJDK" v="false"/>
         </hash>
      </list>
   ...
   <hash n="oracle.jdevimpl.config.JProjectPaths">
      <url n="outputDirectory" path="SOA/SCA-INF/classes/"/>
   </hash>
   <hash n="oracle.tip.tools.ide.fabric.addin.SCAContentSetProvider">
      <hash n="sca-content">
         <list n="pattern-filters">
            <string v="-SCA-INF/classes"/>
            <string v="+**"/>
         </list>
         <list n="url-path">
            <url path="SOA/"/>
